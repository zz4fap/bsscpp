...
{	
	...
	std::cout << "numOfEpochs: " << numOfEpochs << std::endl;
	...
	for(int epoch = 0; epoch < numOfEpochs; epoch++)
	{
		...
		//--------------------------------------------------------------//
	    	ccm->getCrossCorrelationMatrix(y1,y2,R[1]); // R12
	    	acm->getOutputPowerMatrix(y2, (float)10.0, R[3]); // R22
		...
		//--------------------------------------------------------------//
	    	acm->getOutputPowerMatrix(y1, (float)10.0, R[0]); // R11
