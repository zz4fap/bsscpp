...
equalizeEnergyToGreaterOne = false;
...
speakers = struct('speakerrecording', {'F011701.WAV'});
...
N = [256 256 512]; %N = 1024;%1000;%1000;%6000; %220,330, 660, 1200, 2400, 4800, 9600, 19200
L = [64 128 128]; %L = 512;%400;%95;%100;%3, 6, 12Numero de taps dos filtros de de-mixagem(ou seja, a ordem dos filtros)
